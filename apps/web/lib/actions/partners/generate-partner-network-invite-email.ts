...
- Example: if name is "Francesco D'Alessio" and companyName is "Keep Productive Ltd", address the email to "Francesco", not "Keep Productive Ltd".
...
Title: Easlo, we'd love to have you!
